...
#'  \item{MINUTE}{Minute of earthquake.}
...
#'  \item{MONTH}{Month of earthquake.}
...
#'  \item{SECOND}{Secondof earthquake.}
...
#'  \item{YEAR}{Century and Year of earthquake.}
#' }
#' @examples
#' \dontrun{
#'  raw
